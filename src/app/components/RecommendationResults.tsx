				...
				<div className='p-8'>
					...
					<div className='mb-8'>
						<h3 className='text-xl font-heading font-semibold text-gray-800 mb-4 text-center'>
							{assessmentData.occupancyType === "A couple"
								? "See How Couples Thrive at Kensington"
								: "Discover Life at Kensington"}
						</h3>
								...
								>
									...
									<div className='p-4 bg-white'>
										...
										<p className='text-sm font-sans text-gray-600'>
											Comfortable and welcoming living
											space
										</p>
									</div>
								</div>
					...
					<div className='bg-blue-50 rounded-lg p-6 mb-8 text-center'>
						...
						<p className='font-sans text-gray-600'>
							We&apos;ll be in touch soon to discuss your
					...
					<div className='text-center'>
						<div className='bg-gray-50 rounded-lg p-6 mb-6'>
							...
							<p className='font-sans text-gray-600 mb-4'>
								Our senior living specialists will review your
								assessment and contact you within 24 hours to
							...
							<div className='flex items-center justify-center space-x-4 text-sm font-sans text-gray-600'>
								<div className='flex items-center'>
									<div className='w-8 h-8 bg-[#012169] text-white rounded-full flex items-center justify-center text-xs font-bold mr-2'>
										1
									</div>
						...
						<div className='space-y-4'>
							...
							<div className='text-sm font-sans text-gray-600'>
								...
								<p>
									The Kensington Reston • 11501 Sunrise Valley
									Dr. • Reston, VA 20191
								</p>
							</div>
						</div>
