...
export function ContactForm({ contactInfo, setContactInfo, onSubmit, onBack }: ContactFormProps) {
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <input
            ...
            className="w-full p-4 border-2 border-gray-200 rounded-lg focus:border-[#012169] focus:outline-none font-sans"
        ...
        <div>
          <label htmlFor="bestTime" className="block text-sm font-sans font-medium text-gray-700 mb-2">
